...
IMAGE_NAME="alexandredelesse/mealappapi"  # Nom de l'image Docker
IMAGE_TAG="latest"                 # Tag de l'image (par défaut : latest)
CONTAINER_NAME="mealapp-api" # Nom du conteneur
PORT_MAPPING="4000:3001"           # Mapping des ports (hôte:conteneur)
